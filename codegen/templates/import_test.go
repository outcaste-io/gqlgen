...
func TestImports(t *testing.T) {
	...
	aBar := "github.com/outcaste-io/gqlgen/codegen/templates/testdata/a/bar"
	bBar := "github.com/outcaste-io/gqlgen/codegen/templates/testdata/b/bar"
	mismatch := "github.com/outcaste-io/gqlgen/codegen/templates/testdata/pkg_mismatch"
	...
	t.Run("lookup by type", func(t *testing.T) {
		...
		pkg := types.NewPackage("github.com/outcaste-io/gqlgen/codegen/templates/testdata/b/bar", "bar")
	...
	t.Run("string printing for import block", func(t *testing.T) {
		...
		require.Equal(
			t,
			`"github.com/outcaste-io/gqlgen/codegen/templates/testdata/a/bar"
bar1 "github.com/outcaste-io/gqlgen/codegen/templates/testdata/b/bar"
turtles "github.com/outcaste-io/gqlgen/codegen/templates/testdata/pkg_mismatch"`,
			a.String(),
		)
	})
	...
	t.Run("aliased imports will not collide", func(t *testing.T) {
		...
		require.Equal(t, `abar "github.com/outcaste-io/gqlgen/codegen/templates/testdata/a/bar"
bbar "github.com/outcaste-io/gqlgen/codegen/templates/testdata/b/bar"`, a.String())
	})
