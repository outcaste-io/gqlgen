...
$ go get github.com/dgraph-io/gqlgen
```
...
```bash
$ go run github.com/dgraph-io/gqlgen init
```
...
And run `go run github.com/dgraph-io/gqlgen generate`.
...
```go
//go:generate go run github.com/dgraph-io/gqlgen
```
