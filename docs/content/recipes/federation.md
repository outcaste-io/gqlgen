...
server in gqlgen. You can find the finished result in the [examples directory](https://github.com/dgraph-io/gqlgen/tree/master/example/federation).
...
```bash
go run github.com/dgraph-io/gqlgen
```
