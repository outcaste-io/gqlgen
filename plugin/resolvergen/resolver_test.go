...
func TestLayoutSingleFile(t *testing.T) {
	...
	assertNoErrors(t, "github.com/outcaste-io/gqlgen/plugin/resolvergen/testdata/singlefile/out")
}
...
func testFollowSchemaPersistence(t *testing.T, dir string) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/outcaste-io/gqlgen/plugin/resolvergen/"+dir+"/out")
}
